    ...
    private void insertInitialData() {
        try {
            ...
            if (count == 0) {
                ...
                tripEntity3.setTitle("เที่ยวฟินแลนด์แบบฟิน ๆ ไปฟาร์ม Husky ขี่ Reindeer เล่น Snowmobile");
                ...
                tripEntity4.setUrl("https://www.wongnai.com/travel/trips/8cd72c64054344759819b16236407c5b");
                ...
                tripEntity5.setUrl("https://www.wongnai.com/travel/trips/211c8f50221a43d1857d6fbc9099955a");
                ...
                tripEntity7.setTitle("พาเที่ยว “กาญจนบุรี” 2 วัน 1 คืน เก็บทุกไฮไลต์ ลุยไปน้ำตกชั้นเจ็ด!");
                ...
                tripEntity8.setTitle("พาหนุ่มขับรถเที่ยวตัวเมืองกาญจน์ เช็กอินแลนด์มาร์คใหม่ ถ่ายรูปปัง อ่านต่อได้ที่");
